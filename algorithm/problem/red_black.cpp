/*************************************************************************
> File Name: red_black.cpp
> Author:zhaozhicai
> Mail:1871259919@qq.com 
> Created Time: Mon 08 Feb 2021 11:28:40 PM CST
************************************************************************/
...
void output(Node *root,int val){
    if(root==NIL) return ;
    output(root->lchild,val);
    print(root);
    output(root->rchild,val);
    return ;
